...
//['file_thumb', 'file_banner']
//[{current: undefined}, {}]
//{'file_thumb': ref1, 'file_banner': ref2}
export const Form = () => {
    const {
        register,
        handleSubmit,
    ...
    async function onSubmit(formData, event) {
        ...
        sendData['cast_members'] = formData['cast_members'].map(cast_member => cast_member.id);
                ...
                <Grid item xs={12} md={6}>
                    ...
                    <Card className={classes.cardUpload}>
                        <CardContent>
                            ...
                            />
                            <UploadField
                                ref={uploadsRef.current['file_video']}
                                accept={'video/mp4'}
                                label={'Principal'}
                                setValue={(value) => {
